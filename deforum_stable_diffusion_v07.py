...
if __name__ == "__main__":
    ...
    parser.add_argument("prompts_file_path", help="Path to the prompts file")
    parser.add_argument("features_file_path", help="Path to the features file")
    parser.add_argument("output_folder_path", help="Path to the features file")
    parser.add_argument("patch_name", default="M2V", help="subfolder name for the output repository")
    parser.add_argument("fps", default="10", help="FPS for the video to generate")
    parser.add_argument("duration_per_prompt", default="10", help="FPS for the video to generate")
    ...
    with open(m2v_args.input_file_path, 'r') as file:
        for line in file:
            animation_prompts[prompt_count] = '\"'+line+'\"'
            prompt_count++
    ...
    animation_prompts = {
        0:"A neon-lit dancefloor in a gritty underground club, pulsing with groovy techno beats and a frenzied crowd. Cinematic, immersive, art by David Carson.",
        100:"A neon-lit city street at night, bustling with dancing crowds to a groovy techno beat. Hazy, high-gain visuals. Inspired by H.R. Giger. Cinematic masterpiece by Alex Ross.",
        200:"A mesmerizing digital artwork of a neon-lit nightclub, pulsing with energy and vibrant colors, inspired by a techno dance song. Cinematic lighting, volumetric effects, and 4K resolution, created by the renowned visual artist, KAWS.",
        300:"A neon-lit dancefloor in a gritty underground club, pulsing with groovy techno beats and a frenzied crowd. Cinematic, immersive, art by David Carson.",
    }
    ...
    if skip_video_for_run_all == True:
        ...
        # make video
        mp4_path = m2v_args.output_folder_path+'/stable_diffusion/'+m2v_args.patch_name+'.mp4'
        cmd = [
